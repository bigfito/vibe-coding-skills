 ...
 *
 *   npx github:<usuario>/agent-skills
 *
...
${c.bold("Uso")}
  npx github:<usuario>/agent-skills            menú interactivo
...
async function main() {
  ...
  if (interactivo && !stdin.isTTY) {
    ...
    console.error(c.dim("  npx github:<usuario>/agent-skills --all --envs=claude,cursor --yes\n"));
    exit(1);
  }

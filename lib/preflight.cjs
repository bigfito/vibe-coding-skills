 ...
 * Vibe Coding Skills necesita para funcionar? Si falta algo, detecta el sistema
...
/*
 * Qué necesita Vibe Coding Skills para funcionar y qué paquete lo proporciona en cada
...
function asegurarRequisitos(opciones) {
  ...
  // Comprobar nunca cambia el sistema: es la promesa de "solo quiero mirar".
  if (opciones.soloComprobar) {
    console.log('');
    console.log('  ' + c.amar('Esto era solo una comprobación: no se instaló nada.'));
    console.log('  Para que los instale, repite el comando ' + c.bold('sin') + ' ' + c.verde('--check') + '.');
    console.log('');
    return false;
  }

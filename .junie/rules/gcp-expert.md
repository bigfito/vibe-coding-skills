...
> Regla para Junie (IntelliJ IDEA Ultimate). Colócala en `.junie/rules/gcp-expert.md`, o pega su contenido en `.junie/guidelines.md` o en el `AGENTS.md` del proyecto.
>
